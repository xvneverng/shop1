                      ...
                      <el-row>
                        ...
                        <el-col :span="8" :xs="24">
                          <el-form-item>
                            ...
                            <el-button type="danger" icon="el-icon-delete" @click="deletegoodsselect">批量删除</el-button>
                          </el-form-item>
                        </el-col>
                      </el-row>
                      ...
                      <el-table-column
                        ...
                        <el-row slot-scope="scope">
                          ...
                          <el-button type="primary" icon="el-icon-edit" size="mini"
                                     @click="toUpdateGoods(scope.row.id)">修改
                          </el-button>
                          <el-button type="danger" icon="el-icon-delete" size="mini"
                                     @click="deletegoodsjson(scope.row.id)">删除
                          </el-button>
                        </el-row>
                      </el-table-column>
                    </el-table>
