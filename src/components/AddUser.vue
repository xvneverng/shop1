                ...
                <div class="card-body">
                  <div class="basic-form">
                    ...
                    <el-form label-width="120px">
                      ...
                      <el-row>
                        <el-col :span="24">
                          <el-form-item style="display:none;" label="用户id">
                        ...
                        <el-col :span="24">
                          <el-form-item label="账号">
                            <el-input v-model="user.username" name="username" id="username" type="text"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="24">
                        ...
                        <el-col :span="24">
                          <el-form-item>
                            <el-button type="primary" @click="adduseract">添加</el-button>
                          </el-form-item>
                        </el-col>
                      </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      adduseract: function () {
        ...
        this.$axios.post("/adduseractjson", _this.user)
          .then(res => {
