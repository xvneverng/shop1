      ...
      <div class="content-body" style="padding-top: 0;">
        <div class="container-fluid">
          <div class="page-titles">
            <h4 qw-c="operationname">购物车管理</h4>
          </div>
          <div class="row">
            <div class="col-12">
              <div class="card">
                      ...
                      <el-row>
                        ...
                        <el-col :span="8" :xs="24">
                          <el-form-item>
                            ...
                            <el-button type="danger" icon="el-icon-delete" @click="deleteshopcarselect">批量删除</el-button>
                          </el-form-item>
                        </el-col>
                      </el-row>
                      ...
                      <el-table-column
                        ...
                        <el-row slot-scope="scope">
                          ...
                          <el-button type="primary" icon="el-icon-edit" size="mini"
                                     @click="jiesuan(scope.row.id)">结算
                          </el-button>
                          <el-button type="danger" icon="el-icon-delete" size="mini"
                                     @click="deleteshopcarjson(scope.row.id)">删除
                          </el-button>
                        </el-row>
                      </el-table-column>
                    </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toUpdateShopcar(id) {
        this.$router.push("/UserUpdateShopcar?id=" + id);
      },
      goShopcarPage() {
      ...
      searchshopcar: function () {
        ...
        this.$axios.post("/searchshopcarjson", "")
          .then(res => {
            ...
            obj['shopcarall'] = obj['shopcarall'].filter(function (item) {
              return item.state == '未付款';
            });
            ...
            _this.shopcarallorg = _this.shopcarallorg.filter(function (item) {
              ...
              if (item['userid'] != _this.userinfo.id) {
                flag = false;
              }
              return flag;
            });
