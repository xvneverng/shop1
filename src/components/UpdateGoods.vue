                  ...
                  <div class="basic-form">
                    ...
                    <el-form label-width="120px">
                      ...
                      <el-row>
                        ...
                        <el-col :span="24">
                          <el-form-item>
                            <el-button type="primary" @click="updategoodsact">修改</el-button>
                          </el-form-item>
                        </el-col>
                      </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      goodsdetailsjson: function (id) {
        ...
        this.$axios.post("/goodsdetailsjson?id=" + id, "")
          .then(res => {
            ...
            var picarr = _this.goods.pic.split(",");
      ...
      updategoodsact: function () {
        ...
        this.$axios.post("/updategoodsactjson", _this.goods)
          .then(res => {
